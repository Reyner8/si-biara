            ...
            <?php if (!$isEdit) : ?>
                ...
                <?php else : ?>
                    <div class="card">
                        <div class="card-body">
                            <h5 class="card-title">Forms</h5>
                            <form action="/admin/tahapPembinaan/edit/<?= $dataEdit['id'] ?>" method="post">
                                ...
                                <div class="mb-3">
                                    <label for="keterangan" class="form-label">Keterangan</label>
                                    <textarea id="keterangan" class="form-control" name="keterangan" cols="30" rows="10"><?= old('keterangan') ? old('keterangan') : $dataEdit['keterangan'] ?></textarea>
                            ...
                            <table class="table table-bordered border-dark">
                                ...
                                <tbody>
                                    <?php foreach ($listTahapPembinaan as $tahapPembinaan) : ?>
                                        <tr>
                                            <th><?= $tahapPembinaan['nama'] ?></th>
                                            <td><?= $tahapPembinaan['keterangan'] ?></td>
                                            <td>
                                                <a class="btn btn-outline-warning" href="/admin/tahapPembinaan/edit/<?= $tahapPembinaan['id'] ?>"><i class="fa fa-pencil"></i></a>
                                            </td>
                                        </tr>
                                    <?php endforeach; ?>
                                </tbody>
