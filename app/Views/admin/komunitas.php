            ...
            <?php if (!$isEdit) : ?>
                <div class="card">
                    <div class="card-body">
                        ...
                        <form action="/admin/komunitas" method="post">
                            <div class="mb-3">
                ...
                <?php else : ?>
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form action="/admin/komunitas/edit/<?= $dataEdit['id'] ?>" method="post">
                                ...
                                <tbody>
                                    <?php foreach ($listKomunitas as $komunitas) : ?>
                                        <tr>
                                            ...
                                            <td>
                                                <a class="btn btn-outline-warning" href="/admin/komunitas/edit/<?= $komunitas['id'] ?>"><i class="fa fa-pencil"></i></a>
                                                <form action="/admin/komunitas/<?= $komunitas['id'] ?>" method="post">
