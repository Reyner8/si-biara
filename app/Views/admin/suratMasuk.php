            ...
            <?php else : ?>
                <div class="card shadow p-3 mb-5 bg-body rounded">
                    <div class="card-body">
                        ...
                        <form action="/admin/surat/masuk/edit/<?= $dataEdit['id'] ?>" method="post" enctype="multipart/form-data">
                        ...
                        <tbody>
                            <?php foreach ($listSuratMasuk as $suratMasuk) : ?>
                                <tr>
                                    ...
                                    <td>
                                        <a class="btn btn-outline-warning btn-sm" href="/admin/surat/masuk/edit/<?= $suratMasuk['id'] ?>"><i class="fa fa-pencil"></i></a>
                                        <form class="d-inline-block" action="/admin/surat/masuk/<?= $suratMasuk['id'] ?>" method="post">
