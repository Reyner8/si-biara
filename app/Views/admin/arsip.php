                            ...
                            <?php foreach ($listArsip as $arsip) : ?>
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <form class="d-inline-block" action="/admin/arsip/<?= $arsip['id'] ?>" method="post">
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form action="/admin/arsip" method="post" enctype="multipart/form-data">
                    <div class="mb-3">
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <form action="/admin/arsip/<?= $arsip['id'] ?>" method="post" enctype="multipart/form-data">
