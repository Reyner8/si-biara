                        ...
                        <tbody>
                            <?php foreach ($listAnggota as $anggota) : ?>
                                <tr>
                                    ...
                                    <td><span class="badge bg-<?= ($anggota['status'] == 'aktif') ? 'success' : 'danger' ?>"> <?= $anggota['status'] ?></span></td>
                                    <td>
                                        <button type="button" class="btn btn-warning btn-sm" data-bs-toggle="modal" data-bs-target="#penugasan-<?= $anggota['idAnggota'] ?>">
                                            <i class="fa fa-pencil"></i>
                                        </button>
                                        <a class="btn btn-info btn-sm" href="/admin/anggota/detail/<?= $anggota['idAnggota'] ?>">
                                            <i class="fa fa-info"></i>
                                        </a>
                                        <a class="btn btn-secondary btn-sm" href="/admin/anggota/belajar/<?= $anggota['idAnggota'] ?>">
                                            <i class="fa fa-book"></i>
                                        </a>

                                        <form class="d-inline-block" action="/admin/anggota/<?= $anggota['idAnggota'] ?>" method="post">
    ...
    <div class="modal fade" id="penugasan-<?= $modal['idAnggota'] ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="/admin/anggota/<?= $modal['id'] ?>" method="post" enctype="multipart/form-data">
                                ...
                                <table class="table table-borderless">
                                    <tbody>
                                        ...
                                        <tr>
                                            <th>Status</th>
                                            <th>:</th>
                                            <td><span class="badge bg-<?= ($anggota['status'] == 'aktif') ? 'success' : 'danger' ?>"><?= strtoupper($modal['status'])  ?></span></td>
                                        </tr>
