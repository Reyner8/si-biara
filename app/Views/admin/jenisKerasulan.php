            ...
            <?php if (!$isEdit) : ?>
                ...
                <?php else : ?>
                    <div class="card">
                        <div class="card-body">
                            <h5 class="card-title">Forms</h5>
                            <form action="/admin/jenisKerasulan/edit/<?= $dataEdit['id'] ?>" method="post">
                                ...
                                <tbody>
                                    <?php foreach ($listJenisKerasulan as $jenisKerasulan) : ?>
                                        <tr>
                                            ...
                                            <td>
                                                <a class="btn btn-outline-warning" href="/admin/jenisKerasulan/edit/<?= $jenisKerasulan['id'] ?>"><i class="fa fa-pencil"></i></a>
                                            </td>
                                        </tr>
                                    <?php endforeach; ?>
                                </tbody>
