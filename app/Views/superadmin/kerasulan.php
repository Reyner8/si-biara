            ...
            <?php if (!$isEdit) : ?>
                <div class="card shadow p-3 mb-5 bg-body rounded">
                    <div class="card-body">
                        ...
                        <form action="/sa/kerasulan" method="post" enctype="multipart/form-data">
                            <div class="mb-3">
                ...
                <?php else : ?>
                    <div class="card shadow p-3 mb-5 bg-body rounded">
                        <div class="card-body">
                            ...
                            <form action="/sa/kerasulan/edit/<?= $dataEdit['id'] ?>" method="post" enctype="multipart/form-data">
                                ...
                                <div class="mb-3">
                                    ...
                                    <select class="form-select form-select-sm" aria-label=".form-select-sm example" name="idKomunitas">
                                        <option selected>Open this select menu</option>
                                        <?php foreach ($listKomunitas as $komunitas) : ?>
                                            <?php if ($komunitas['id'] == $dataEdit['idKomunitas']) : ?>
                                ...
                                <tbody>
                                    <?php foreach ($listKerasulan as $kerasulan) : ?>
                                        <tr>
                                            ...
                                            <td>
                                                <a class="btn btn-outline-warning btn-sm" href="/sa/kerasulan/edit/<?= $kerasulan['id'] ?>"><i class="fa fa-pencil"></i></a>
                                                <form class="d-inline-block" action="/sa/kerasulan/<?= $kerasulan['id'] ?>" method="post">
