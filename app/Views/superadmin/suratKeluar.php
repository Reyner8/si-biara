            ...
            <?php if (!$isEdit) : ?>
                <div class="card shadow p-3 mb-5 bg-body rounded">
                    <div class="card-body">
                        ...
                        <form action="/sa/surat/keluar" method="post" enctype="multipart/form-data">
                            <div class="mb-3">
                        ...
                        <tbody>
                            <?php foreach ($listSuratKeluar as $suratKeluar) : ?>
                                <tr>
                                    ...
                                    <td><?= $suratKeluar['namaKomunitas'] ?></td>
                                    <td>
                                    ...
                                    <td>
                                        <a class="btn btn-outline-warning btn-sm" href="/sa/surat/keluar/edit/<?= $suratKeluar['id'] ?>"><i class="fa fa-pencil"></i></a>
                                        <form class="d-inline-block" action="/sa/surat/keluar/<?= $suratKeluar['id'] ?>" method="post">
