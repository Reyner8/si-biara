            ...
            <?php if (!$isEdit) : ?>
                ...
                <?php else : ?>
                    <div class="card shadow p-3 mb-5 bg-body rounded">
                        <div class="card-body">
                            <h5 class="card-title">Forms</h5>
                            <form action="/sa/tahapPembinaan/edit/<?= $dataEdit['id'] ?>" method="post">
                                ...
                                <div class="mb-3">
                                    <label for="textarea" class="form-label">Keterangan</label>
                                ...
                                <tbody>
                                    <?php foreach ($listTahapPembinaan as $tahapPembinaan) : ?>
                                        <tr>
                                            ...
                                            <td>
                                                <a class="btn btn-outline-warning" href="/sa/tahapPembinaan/edit/<?= $tahapPembinaan['id'] ?>"><i class="fa fa-pencil"></i></a>
                                            </td>
                                        </tr>
                                    <?php endforeach; ?>
                                </tbody>
