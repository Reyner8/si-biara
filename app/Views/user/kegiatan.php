            ...
            <?php if (!$isEdit) : ?>
                <div class="card">
                    <div class="card-body">
                        ...
                        <form action="/user/kegiatan" method="post" enctype="multipart/form-data">
                            <div class="mb-3">
                ...
                <?php else : ?>
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form action="/user/kegiatan/edit/<?= $dataEdit['id'] ?>" method="post" enctype="multipart/form-data">
                                ...
                                <tbody>
                                    <?php foreach ($listKegiatan as $kegiatan) : ?>
                                        <tr>
                                            ...
                                            <td>
                                                <a class="btn btn-outline-info btn-sm" href="/user/galeri/<?= $kegiatan['id'] ?>"><i class="fa fa-info"></i></a>

                                            </td>

                                            <td>
                                                <a class="btn btn-outline-warning btn-sm" href="/user/kegiatan/edit/<?= $kegiatan['id'] ?>"><i class="fa fa-pencil"></i></a>
                                                <form class="d-inline-block" action="/user/kegiatan/<?= $kegiatan['id'] ?>" method="post">
